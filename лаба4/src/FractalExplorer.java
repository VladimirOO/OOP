...
public class FractalExplorer {
    ...
    //конструктор,который инициализирует объекты диапазона и
    ...
    //Обрабатывает нажатие кнопки и сбрасывает диапазон к начальному, определенному генератором, а затем
    ...
    // обработчик при получении события о щелчке мышью, вызывает метод генератора
    // recenterAndZoomRange()  с коор. по которым щелкнули, и масштабом 0.5.
